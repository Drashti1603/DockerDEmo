    ...
    stage('Checkout') {
      steps {
        script {
           ...
           git credentialsId: 'jenkins-user-github', url: 'https://github.com/Drashti1603/DockerDEmo.git'
        ...
        stage('build') {
            ...
            steps {
                script{
                    ...
                    sh "docker build -t 20it017/devops_img:${IMAGE_NAME} ."
                    }
            }
        }
      stage('test') {
        ...
        // }
            steps {
                ...
                withCredentials([usernamePassword(credentialsId: 'docker', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD')]){
                    ...
                    sh "docker push 20it017/devops_img:${IMAGE_NAME}"
                }}
